...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      "z-50 min-w-[10rem] overflow-hidden rounded-lg border border-[--color-border] bg-white p-1 text-[--color-foreground] shadow-elevated",
      "data-[state=open]:animate-[scale-in_0.15s_ease-out]",
      "data-[state=closed]:animate-[scale-in_0.1s_ease-out_reverse]",
      className
    )}
    {...props}
  />
